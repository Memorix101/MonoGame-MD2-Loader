     ...
     //   protected override void LoadContent( bool loadAllContent ) {
        ...
        protected override void LoadContent()
        {
            ...
            if ( true ) {
                ...
                Goblin.LoadFromFile("Content/Models/Goblin/model.md2");
                ...
                Goblin.DefineSkin("Stone Goblin", "Content/Models/Goblin/Skins/stone-goblin.jpg");
                Goblin.DefineSkin("Ice Goblin", "Content/Models/Goblin/Skins/ice-goblin.jpg");
                Goblin.DefineSkin("Fire Goblin", "Content/Models/Goblin/Skins/red-goblin.jpg");
                ...
                Knight.LoadFromFile("Content/Models/Knight/model.md2");
                Knight.DumpAnimationListToFile(@"..\..\..\KNIGHT-ANIMATIONS.TXT");

                Knight.DefineSkin("Light Knight", "Content/Models/Knight/Skins/standard-knight.jpg");
                Knight.DefineSkin("Dark Knight", "Content/Models/Knight/Skins/dark-knight.jpg");
                ...
                Mushroom.LoadFromFile("Content/Models/Mushroom/model.md2");
                Mushroom.DumpAnimationListToFile(@"..\..\..\MUSHROOM-ANIMATIONS.TXT");

                Mushroom.DefineSkin("Bland", "Content/Models/Mushroom/Skins/standard.jpg");
